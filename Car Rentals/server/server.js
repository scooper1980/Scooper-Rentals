...
app.get(["/payments/config", "/api/payments/config"], (_req, res) => {
  res.json({
    provider: "paystack",
...
app.get(["/bookings", "/api/bookings"], async (_req, res) => {
...
app.patch(["/bookings/:id/payment-status", "/api/bookings/:id/payment-status"], async (req, res) => {
  const { id } = req.params;
...
app.post(["/admin-staff/register", "/api/admin-staff/register"], async (req, res) => {
...
app.post(["/admin-staff/login", "/api/admin-staff/login"], async (req, res) => {
...
app.get(["/messages", "/api/messages"], async (_req, res) => {
  const messages = await readCollection(MESSAGES_KEY, messagesFile);
  res.json(messages);
});

app.post(["/messages", "/api/messages"], async (req, res) => {
...
app.post(["/payments/paystack/initialize", "/api/payments/paystack/initialize"], async (req, res) => {
...
app.get(["/payments/paystack/verify/:reference", "/api/payments/paystack/verify/:reference"], async (req, res) => {
